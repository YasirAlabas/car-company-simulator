...
// charge the card and make the reservation.
public class Payment extends javax.swing.JFrame {
    ...
    public Payment(Costumer user, Car car, double cost, Date endDate) {
        initComponents();
        this.user = user;
        this.car = car;
        this.cost = cost;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new ChoosePayment(user, car, cost, endDate).setVisible(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (datestring.equals("") || address.equals("")) {
                ...
                JOptionPane.showMessageDialog(null, "Your Rental is Compelete", "Payment Succesfull", JOptionPane.INFORMATION_MESSAGE);
                Reservation reservation = new Reservation(user, car, endDate);
